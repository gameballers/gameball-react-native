...
export class InAppMessagingService {
  ...
  /** Keeps the next-best campaign for this occurrence behind the one on screen. Only when the winner took the screen. */
  ...
  /** Retries the parked message the moment the floor lapses. */
