 ...
 * frequency caps and the analytics outbox lasting only as long as the process. Requiring it here
 * rather than importing it keeps the module out of the bundle of an app that does not have it.
 */
